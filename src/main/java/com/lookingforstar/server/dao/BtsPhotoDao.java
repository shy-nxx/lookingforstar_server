...
import com.lookingforstar.server.dao.mybatis.mapper.PhotoMapper;
...
public class BtsPhotoDao {
	...
	public void insertPhoto(List<String> list) {
		for (String imageUrl : list) {
			System.out.println(photoMapper.insertBtsPhoto());
		}
...
//	}
	...
	public List<GooglePhotoItem> selectPhoto() {
		List<GooglePhotoItem> result = photoMapper.getBtsPhoto();
